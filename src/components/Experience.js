  ...
  return <section className='mb-12 lg:mb-24'>
    <div className="container mx-auto">
      <div className='flex flex-col min-h-[480px] lg:space-x-20 lg:flex-row '>
        ...
        {/* text */}
        <div className='flex-1 flex flex-col items-start justify-center mt-6 lg:mt-09' data-aos='fade-left'
          data-aos-offset='400'>
          <h2 className='text-3xl font-bold mb-6 '>New Experience in Playing Games</h2>
          <p className='font-secondary mb-6' >
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ab maxime quia esse error quo facere, quisquam omnis eum, soluta adipisci qui modi.
          </p>
